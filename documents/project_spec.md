...
```mermaid
graph TD
    Reviews[app_store_reviews.csv] --> CSVReader[CSV Reader Agent]
    Emails[support_emails.csv] --> CSVReader
    
    CSVReader --> Classifier[Feedback Classifier]
    
    Classifier --> BugAnalyzer[Bug Analyzer]
    Classifier --> FeatureExtractor[Feature Extractor]
    Classifier --> Other[Other pass]
    
    BugAnalyzer --> TicketCreator[Ticket Creator]
    FeatureExtractor --> TicketCreator
    Other --> TicketCreator
    
    TicketCreator --> QualityCritic[Quality Critic]
    
    QualityCritic --> Tickets[generated_tickets.csv]
    QualityCritic --> Logs[processing_log.csv]
    
    style Reviews fill:#e3f2fd,color:#000000
    style Emails fill:#e3f2fd,color:#000000
    style CSVReader fill:#fff9c4,color:#000000
    style Classifier fill:#f3e5f5,color:#000000
    style BugAnalyzer fill:#ffebee,color:#000000
    style FeatureExtractor fill:#e8f5e9,color:#000000
    style TicketCreator fill:#fff3e0,color:#000000
    style QualityCritic fill:#fce4ec,color:#000000
    style Tickets fill:#e1f5fe,color:#000000
    style Logs fill:#e1f5fe,color:#000000
```
